        ...
        <div class="">
          ...
          <div class="clearfix"></div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Sports Equipment Booking</h2>
                ...
                <div class="well" style="overflow: auto">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Select Sport Name</label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Select Equipment</label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Enter Quantity</label>
                        <input style="width: 184px!important;  padding: 6px;" type="number" name="equipment_qty" placeholder="Quantity" required>
                      </div>
...
if(isset($_POST['req_booking'])){
    ...
    if (!empty($sport_name) and !empty($Equipment_name) and !empty($equipment_qty)) {
        
        $sql = "INSERT INTO `tbl_tmp_booking`( `sports_name`, `equip_name`, `quantity`, `booking_startdate`,`booking_starttime`,`booking_enddate`,`booking_endtime`, `book_req_by`) 
        VALUES ('$sport_name','$Equipment_name', '$equipment_qty','$booking_startdate','$booking_starttime','$booking_enddate','$booking_endtime','$user_role')";

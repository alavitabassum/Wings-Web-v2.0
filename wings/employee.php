        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title m-e-form ">
              ...
              <form id="example-form" action="{{route('addEmployee')}}" method="POST" role="form">
                  <div>
                      ...
                      <section>
                          ...
                          <select class="form-dropdpwn" name="district_id">
                          ...
                          <select class="form-dropdpwn" name="thana_id">
                    ...
                    <input type="text" name="nid" value="" class="required number">
                      ...
                      <section>
                       ...
                       <label for="bank_id">Bank</label>
                          <select class="form-dropdpwn" name="bank_id">
                    ...
                    <input type="number" name="point_id" value="" class="required">
